...
local function m39k()
	...
	hl("TabLineSel", { fg = colors.blu0, bg = colors.bg0, bold = true })
	...
	hl("Conditional", { fg = colors.red0 })
	hl("PreCondit", { fg = colors.red0 })
	--- 3blue
	...
	hl("@string.regexp", { fg = colors.yel0 })
	...
	--- markdown
	hl("@markup.heading", { fg = colors.yel0 })
	...
	hl("@markup.raw", { fg = colors.ora0 })
	hl("@variable.parameter.vimdoc", { fg = colors.ora0 })
